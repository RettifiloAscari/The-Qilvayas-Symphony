...
children.push(H1("Titles and Forms of Address"));
children.push(P("The empire keeps no single order of precedence, and that is not an oversight. Two centuries of fracture left the Throne granting titles it can no longer enforce and recognizing titles it never granted \u2014 so a Voivode and a Duke are not two rungs of one ladder but the heads of two different kinds of thing. Five ladders run in parallel, each to its own summit."));
children.push(BUL("The Throne and the Court:", "Emperor; Lord Chamberlain (who keeps access to the Emperor\u2019s person); Archjurist (who holds the pen on the new Laws); Mistress or Master, the style of a commoner heading an imperial bureau; Magistrate, judge and civil administrator in one office. Precedence here is by access rather than rank \u2014 which is why the Lord Chamberlain, who commands no soldiers and holds no land, is one of the most powerful people in Aenodira."));
children.push(BUL("The Legions:", "Legionary, Sergeant, Centurion, Colonel, Legate. Marshal is not a rung on that ladder but an acclamation of the Throne for extraordinary renown, which is why a Marshal may command far less than a Legate and weigh far more in the public mind. Captain is a courtesy title for anyone leading an irregular company."));
children.push(BUL("The Church:", "Matriarch, the Voice of the Matron in the capital, advised and constrained by the Synod of the Grey; Prelate, who heads an office of jurisdiction such as the Office of Omens; Hierophant, who heads the Keepers of the Ascent \u2014 the imperial cult, a parallel body and not Church clergy at all. A Prelate holds his writ from the Synod rather than from the Matriarch, so there is rarely a head to appeal over."));
children.push(BUL("The Academy:", "Chancellor at the head; Professors, senior faculty who may hold a named charge such as Master of Trials; Instructors, junior faculty; and the Archivist, who keeps the restricted stacks. Professor Emeritus is retained for life, whatever the circumstances of the departure."));
children.push(BUL("Sovereign and border styles:", "King; Sea-King, king of a people rather than a territory; Voivode, Tarnovar\u2019s war-leader raised to sovereign; Ban, a march-warden holding a frontier for a Voivode; Duke and Duchess, the imperial ducal houses; Count and Countess beneath them; Lord for any landholder with retainers and no better title; Harborlord for Velmareth\u2019s ruling merchant-bankers; Guildmaster for the head of a chartered trade body; and Saint-Regent, unique to Olvesa."));
children.push(P("One distinction is worth carrying to any negotiation. Duke Norr and Voivode Morn are not peers of unequal rank \u2014 their titles are different in kind. Norr\u2019s is imperial, granted by the Lupine Throne, which makes him on paper the Emperor\u2019s own subject. Morn\u2019s is foreign and owes Aenodira nothing whatever. A Voivode who defies the Throne is a neighbor; a Duke who does it is a precedent."));
children.push(P("Where the ladders cross \u2014 and a Prelate, a Legate, and a Duchess share no scale at all \u2014 the empire runs on an unwritten rule: precedence at court is by access, in the provinces by force, and in a shrine by rite. What happens when those three disagree has never been set down."));
children.push(table(["Speaking to", "Say"], [38, 62], [
...
children.push(P("Getting one of these wrong is not a crime and rarely even an insult \u2014 the empire is large and its usages vary. Getting one deliberately wrong is a sentence with a knife in it, and every soul in the room will hear it land."));
...
children.push(table(["Item","Price","Item","Price"],[36,14,36,14],[
