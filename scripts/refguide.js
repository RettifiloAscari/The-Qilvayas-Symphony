...
c.push(H1("The Aspects \u2014 Domains at a Glance"));
c.push(table(
...
c.push(PS([{ t: "Paladin oaths: Devotion = Crown-sworn and the Church\u2019s Oathwards (Qilvayas). Ancients = the Green Watch, the Old Observance\u2019s unlicensed paladins. Vengeance = the Wolf-Price as vocation (Dregan Morn). DM ONLY \u2014 Oathbreaker is not a subclass here, it is the Founder\u2019s own road, and the thing beneath Aenodira notices immediately.", i: true }]));

c.push(H1("The Saints \u2014 Feasts at a Glance"));
c.push(table(
...
c.push(H1("Standing \u2014 Faction Tiers"));
c.push(PS([{ t: "One number per faction, 0 to 5, moved by the DM at session end. Tier 2 grants advantage on Charisma checks against members; tier 3 opens the faction\u2019s own asset; tier 5 is a promise, and in this world a promise is a weight.", i: true }]));
c.push(table(
...
c.push(PS([{ t: "Opposed pairs: Orlath vs. the Church. Vaelindra vs. the Office. Inkhands vs. the Law Commission. Tarnovar vs. the Court. Golds vs. Greys. Concord vs. the Legions. The Academy opposes nothing, which is why it is the best cover in the empire. The Church and the Throne are deliberately not opposed \u2014 the day one of them forces a choice is a campaign event.", i: true }]));

c.push(H1("Keyed Locations \u2014 Where to Look"));
c.push(table(
...
c.push(BUL("Wardstone Shard (common, unique source):", "Dim wolf-gray light 10 ft; gutters within 30 ft of Undercourt cold."));
