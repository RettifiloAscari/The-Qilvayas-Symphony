...
cA.push(BUL("Advancement:", "Milestone leveling recommended. Suggested pace: 4th level after the meeting with the Seeress concludes (early Session Three); 5th at the close of the Proving (end of Session Four); 6th at the Second Seal (end of Session Six); 7th in the Witness Hall (end of Session Seven); 8th when the Vigil is kept (end of Session Eight). XP totals are listed in the session documents for tables that prefer XP."));
