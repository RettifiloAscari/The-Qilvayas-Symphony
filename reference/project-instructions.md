...
Closed so far: calendar, funerary custom and the Vigil, marriage/inheritance/succession, bound labor and legal personhood, gender and authority. Still open, in no fixed order — offer these when the corpus needs depth rather than plot:
