...
Closed so far: calendar, funerary custom and the Vigil, marriage/inheritance/succession, bound labor and legal personhood, gender and authority, the imperial law pass (the Zhuvedian Laws in seven Books, certification, jurisdiction, the legions' rank ladder, street-level justice, and the Golden Tablets quoted in fragment), language and literacy, and the currency (the Zhuven).
