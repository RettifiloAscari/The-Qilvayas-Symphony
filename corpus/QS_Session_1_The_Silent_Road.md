...
**Session One: The Silent Road**

*The Qilvayas Symphony*

*An adventure for 4–6 characters of 3rd level — the final field exercise, and the night everything changes*
...
Half a day east: an overturned wagon, scattered grain gone to birds, wheel ruts, and a burned cookfire. Investigation is tiered — every character who searches learns the DC 10 information automatically on a success; higher results stack additional detail.

- **DC 10 (Investigation or Survival):** Eight to ten attackers on foot. They took food and supplies first, strongboxes second. Tracks lead northeast into the hills.
- **DC 13:** Boot prints are legion-issue, uniform pattern and wear — these are soldiers, or were. The ambush used proper fire discipline and a bounding withdrawal: trained, coordinated, rehearsed.
- **DC 15:** One set of prints is wrong. The stride is even but the weight is off, as though the man is lighter than his boots — and beside the cold cookfire, one patch of ground is scorched in a shape no fire makes: a long, thin shadow of a standing man, burned into the grass.
...
**R6. The Keep, Ground Floor.** One room, a hearth, a table, Dren’s things. What passes for the band’s business is done here. The stair to the upper floor is intact for eight feet and then is not.
...
***Scavenger’s Nerve.*** The looter has disadvantage on saving throws against being frightened. It flees when reduced to half its hit points or when half its group has fallen.
...
***Sleepless.*** The scout has disadvantage on saving throws against being frightened, and against effects that would put it to sleep it instead automatically fails. (It has not truly slept in weeks; part of it wants to.)

**ACTIONS**

***Multiattack.*** The scout makes two shortsword attacks or two shortbow attacks.
...
**Armor Class:** 14 (worn chain shirt)
...
***Legion Discipline.*** While within 5 feet of another Oathless Deserter, the deserter has a +1 bonus to AC (drilled shield-line habits die hard).

***Haunted.*** The deserter has disadvantage on saving throws against being frightened. If it witnesses the Umbral Remnant, it must succeed on a DC 13 Wisdom saving throw or drop its weapons and flee or surrender.

**ACTIONS**

***Multiattack.*** The deserter makes two spear attacks.

***Spear.*** Melee or Ranged Weapon Attack: +4 to hit, reach 5 ft. or range 20/60 ft., one target. Hit: 5 (1d6 + 2) piercing damage, or 6 (1d8 + 2) piercing damage if used with two hands to make a melee attack.

**Sergeant Varkos Dren**

*Medium humanoid (human), neutral evil (by despair, not design)*

**Armor Class:** 15 (studded leather, shield fragments)
...
***Shadow-Touched.*** While Dren is below half his hit point maximum (or from the start of combat, for a party of six), his weapon attacks deal an extra 3 (1d6) necrotic damage, and his shadow visibly moves a half-beat behind his body.

***No Way Back.*** Dren has advantage on saving throws against being frightened and against any effect that would charm him into standing down. He cannot be talked into surrender — only into fighting alone.

***Final Tearing.*** When Dren is reduced to 0 hit points, the Umbral Remnant erupts from his body in his space and rolls initiative. Dren cannot be returned to life by any means available at this tier; the body is unnaturally light.

**ACTIONS**

***Multiattack.*** Dren makes two longsword attacks.
...
***Parry.*** Dren adds 2 to his AC against one melee attack that would hit him. To do so, he must see the attacker and be wielding a melee weapon.

**Umbral Remnant**

*Medium undead (residue), chaotic evil*

**Armor Class:** 12

**Hit Points:** 16 (weakened fragment; see Dissolution)
...
## Encounter Heat — DM Awareness (Validation Pass)
