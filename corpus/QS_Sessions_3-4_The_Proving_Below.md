...
- Why them and not faculty: “Because you are the cohort that cleared Redwatch, and because every instructor who can fight is examining first-years this week. Consider it a compliment with teeth.”
- The compensation, delivered with a perfectly straight face: “Succeed, and the chancellery will consider your final examinations satisfied.” (Every word of the briefing is technically true. This line is the module’s best joke, and nobody will get it for two sessions.)

Give them a preparation beat — equipment requisitions are approved with suspicious speed — and one detail for later: Dail’s provided map of Levels One and Two is precise, professional, and has one drafting smudge on the eastern edge of Level Two, as though something was erased or never surveyed. A DC 15 Intelligence (Investigation) check on the map notices it now; otherwise it lands in retrospect.

## Scene 3: Level One — The Archive Halls

> *The Undervault opens off a stair behind three locks, and the air changes on the fourth step — dry, cold, papery, old. Below, corridors run straight and square under barrel vaults, lined with iron shelf-cages of ledgers nobody has touched in a century. Your lanterns push the dark back exactly as far as lantern-light should, and no further. Somewhere below, metal scrapes on stone — once, deliberately, like something finishing a step.*

Run Level One as a classic corridor-and-chamber crawl — encourage a player to map. This level teaches the dungeon’s vocabulary and stages the missing-team fiction:

- **The survey camp.** Bedrolls, a cold lamp, a half-written catalogue page ending mid-line, and a scatter of dropped instruments — staged with real skill. DC 13 Investigation: the scene reads genuinely wrong-but-recent. DC 16: the lamp’s oil level and the dust say the camp is older than five days — the first loose thread, if anyone pulls it.
...
**Languages:** understands Old Imperial commands

**Challenge:** 1 (200 XP)

***Training Protocol.*** The automaton cannot reduce a creature below 1 hit point unless that creature has attacked it since the start of its last turn; against downed or unconscious creatures it visibly checks its swing and re-targets. A creature that observes this in combat may make a DC 13 Wisdom (Insight) check to register that the behavior is deliberate.

***Antique Joints.*** If the automaton takes a critical hit, its speed is halved until the end of its next turn as servos grind.

**ACTIONS**

***Multiattack.*** The automaton makes two padded-mace attacks.

***Padded Mace.*** Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 6 (1d8 + 2) bludgeoning damage.

**Vault Hound**

*Medium beast, unaligned (compelled)*
...
***Binding Collar.*** A bronze collar (AC 15, 10 hp, immune to poison and psychic damage) compels the hound’s aggression. If the collar is destroyed, or removed from a restrained hound with a successful DC 13 Dexterity check, the hound immediately ends all hostility, becomes docile, and thereafter treats its liberators as pack. A DC 12 Intelligence (Arcana) check identifies the collar’s runes as compulsion binding.

**ACTIONS**

***Bite.*** Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 7 (2d4 + 2) piercing damage, and if the target is a creature it must succeed on a DC 12 Strength saving throw or be knocked prone.
...
| **STR** | **DEX** | **CON** | **INT** | **WIS** | **CHA** |
| --- | --- | --- | --- | --- | --- |
| 14 (+2) | 3 (−4) | 16 (+3) | 1 (−5) | 6 (−2) | 1 (−5) |

**Damage Immunities:** acid, slashing (splits it into two smaller custodians of half remaining hit points each, which continue cleaning)
...
***Sanitation Directive.*** The Custodian does not attack creatures unless attacked first or physically obstructed while consuming a mess. It pursues spills, decay, and debris with single-minded diligence, including any carried open food or unstoppered oil a creature is foolish enough to hold near it.

***Transparent.*** Even when in plain sight, a creature that hasn’t witnessed the Custodian move must succeed on a DC 14 Wisdom (Perception) check to notice it.

**ACTIONS**

***Dissolving Pseudopod.*** Melee Weapon Attack: +4 to hit, reach 10 ft., one target. Hit: 10 (3d6) acid damage, and nonmagical leather or cloth worn by the target is stained pristinely clean.

**Bartleby (Elder Mimic)**

*Medium monstrosity (shapechanger), neutral (food-motivated)*
...
**Languages:** — (recognizes roughly forty words, most of them foods)

**Challenge:** 2 (450 XP)

***Shapechanger.*** Bartleby can use its action to polymorph into an object or back into its amorphous form. Its statistics are the same in each form. It reverts if it dies, or if offered something demonstrably delicious.

***Adhesive (Object Form Only).*** Bartleby adheres to anything that touches it. A Huge or smaller creature adhered to it is also grappled (escape DC 13).

***Semi-Tame.*** Bartleby releases any grapple and returns to furniture-shape on a stern word from any creature that has ever fed it, or on presentation of food. It has been fed by four generations of Undervault staff and considers grappling a form of enthusiastic greeting.

**ACTIONS**

***Pseudopod.*** Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 7 (1d8 + 3) bludgeoning damage plus the Adhesive trait.
...
**Languages:** Old Imperial, Common

**Challenge:** 5 (1,800 XP)

***Warrant Protocol.*** The Warden stands down permanently if presented a valid Warrant of Access, or if the archivists’ stand-down formula is spoken to it in Old Imperial (discoverable via the plinth inscriptions, DC 15 Intelligence (History), usable as an action).

***Yield Protocol.*** When reduced below half its hit point maximum, the Warden grounds its weapon, kneels, and ends all hostility, announcing “SUFFICIENT.” Its purpose has always been to test, not to destroy.

***Bulwark (Six-Character Parties Only).*** While at least one allied Drill Automaton is active, the Warden has a +2 bonus to AC.

***Sentinel Stance.*** When the Warden hits a creature with an opportunity attack, the creature’s speed becomes 0 for the rest of the turn.

**ACTIONS**

***Multiattack.*** The Warden makes two halberd attacks.

***Halberd.*** Melee Weapon Attack: +8 to hit, reach 10 ft., one target. Hit: 15 (3d6 + 5) slashing damage.

***Warding Sweep (Recharge 5–6).*** The Warden sweeps its halberd in a 15-foot cone. Each creature in the cone must succeed on a DC 15 Dexterity saving throw or take 14 (4d6) bludgeoning damage and be knocked prone; on a success, half damage and the creature is not knocked prone.

**REACTIONS**

***Grounded Guard.*** When a creature the Warden can see attacks the plinth or the Lector’s Seal, the Warden moves up to half its speed toward the attacker without provoking opportunity attacks.
...
*“So the school sent you down after all. And you paid attention to what was cold. Good. Now sit, children, and tell me about the door — and I will tell you why the Empress’s hand shakes in that cipher.”*
