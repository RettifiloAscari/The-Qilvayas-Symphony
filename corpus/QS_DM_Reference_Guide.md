...
*Marked (tiefling) personhood beyond Velmareth’s exception: LIVE thread, not resolved by this pass — see Branch Ledger and Items/Threads. Book One’s one clause the Commission hasn’t closed; party action before the Solacre promulgation can tip it either way.*
...
## Sessions 5–6 NPCs (the Capital Threads)
...
- **The Weight of the Word:** Sworn words have literal metaphysical weight — the setting’s signature. No mechanics; pure adjudicated flavor. Oath-breaking at scale scars ground (thin-written places: wards fail, divination sours, cold holds).
- **The Sanction:** The Church licenses divine practice (pewter warrant-medals); the Matron answers everyone sincere regardless. Orlath runs a rival sanction. Unsanctioned healers = Office of Omens business.
- **Chartered Thaumaturgy:** Arcane magic is credentialed and bureaucratic; hedge-mages tolerated till trouble; Rivergate sells unlicensed scrollwork. Sorcerers (‘the Kindled’) suspect; warlocks (‘the Sworn’) theologically radioactive — a pact is an oath that answered.
- **Night iconography:** The She-Wolf of the Night Sky — moon her eye, stars her pack, liturgies sung at night. The coronation prayer is theologically literal.
- **Lycanthropy:** Doctrine: profanation, hunted (wolf-trials). Folk belief: sometimes her mark. The gothic engine between the two is deliberate.
- **Wildshape:** Doctrine-clean — no wolf-trial jurisdiction; willed shape isn’t profanation. Office of Omens keeps a quiet interest-file on frequent/public shapeshifters anyway: leverage without threat, not persecution.
- **Wolf-Price:** Self-defense = valid legal defense (report to a magistrate within 3 days, produce the body). Separate older custom: a debt to the local shrine-keeper regardless of guilt — reputation/plot hook, not legal jeopardy. Unpaid = worse than a magistrate’s file, especially off the Crownlands.
- **Companions:** Befriended wolf = the Matron’s visible favor (social standing + Office interest); Beast Master ranger w/ wolf = the permanent version (touched in the provinces, on file in the capital); druids get wildshape instead, per doctrine. Caged/collared wolf = profanation-scandal. DM: wolves refuse thin-written ground — a companion wolf is a living Wardstone, and none will enter the Old Forum district.
- **Funerary custom:** Universal night Vigil before disposal (doctrine-locked, every region — the Matron watches the dead home at night). After varies hard: Aenodira Bone Galleries (upper levels public; deep levels closed ‘for consolidation’ generations ago — keeps funerals clear of the Session 6 route), Suthmark harvest-calendar burial, Tarnovar oath-inheritance over body-burial, Velmareth reed-sea barges. Any ordinary town: a Vigil Hall, whose keepers are the best-informed people in town.
- **Item economy:** Arcana scarce/chartered; relics & blessed items flow through the faith (stamped potions 50 gp at almonries; false-relic trade in Rivergate). Wolves sacred everywhere; DM: Aenodira’s wolves have been leaving the Old Forum for 3 years.

# Peoples — Quick Reference

- **Drow — the Founder’s Blood:** Zhuvedus AND Threnvos both Drow (canon). Dynasty = his line, nearly alone. Any other Drow = enormous statement. OPEN: does Threnvos’s line survive? (Do not spend early.)
- **Placement:** Dwarves: Tarnovar (Stonesworn, ~1/3), Suthmark hills, capital masons. Wood elves: Old Wood + Ardven wilds. Half-orcs: Ostmark legion stock. Halflings: river trade/Coppergate. Gnomes: the Craft. Tieflings: the Marked (covenant-scarred lines). Dragonborn: Sarkanni mercenary lodges (contract-perfect, remarked upon).
- **Roster race calls:** Vell hill dwarf; Mosse rock gnome; Halloc half-orc; Brakka dwarf; Vhal half-elf; Sorral half-elf (canon); Nyreeza Drow wizard. All Powers human; dynasty alone Drow.

# Dragons of the Fractured Age

| **Dragon** | **Where** | **The Short Version** |
| --- | --- | --- |
...
- **Book One — Of Persons:** Bound labor unchanged (see above) + NEW: an oath-bound service/indenture must be witnessed and recorded to be enforceable. Unwitnessed = not illegal, just unenforceable. Marked personhood generalized beyond Velmareth: LIVE Branch Ledger thread — see Branch Ledger and Items/Threads.
...
- **Zhuvedus:** Empire’s founder. Was a paladin, Oath of Devotion (canon). Broke a sworn covenant with his rival Threnvos, killing him under the Matron’s own witness, and fell to Oathbreaker in the same act — the power that let him found the empire alone.
- **The Lupine Matron:** The chief goddess, ancient, predates Zhuvedus and has guided many champions across history. Zhuvedus was simply the most successful. His own divinity is genuinely contested (three competing doctrines — see sourcebook).
- **Threnvos:** Zhuvedus’s rival and co-claimant, betrayed and destroyed. His people survive today as Tarnovar; “Vosthren” in their ballads is his name, syllable-inverted by drift.
- **The Shadow:** Threnvos’s dying essence fused with the impersonal force unleashed by the broken oath — personal grievance and impersonal hunger, born together. Fed since by every broken oath in the empire’s 200-year fracture. NEVER state this to players; seed only in fragments.
- **The Binding Site:** CONFIRMED CANON: beneath the Old Forum, in the Undercourt’s deepest reach, touching the Academy’s Undervault. Sessions 5–6 carry the party to the Second Seal at its threshold. Full site design beyond the Seal still pending.
- **Empress Nyreeza:** Disappeared 3 years ago (timeline fixed). Working theory: she was investigating the true founding account and found the binding site, or evidence of it. Her cipher marks appear in the Undervault (Cold Door) and the wider Undercourt. Exact fate: still open by design.
- **The Proving:** Real academy tradition — a staged final exam mistaken for reality by the cohort undergoing it. Subject of Sessions 3–4. Players must never hear the word before it happens.
...
- **Dren’s oath-medallion:** Defaced, permanently cold, non-detectable as magical. First physical artifact of the truth. (Session 1)
...
- **Marked Personhood — the Live Clause:** Vhal’s Commission hasn’t settled Book One’s treatment of the Marked; Velmareth’s standing exception is the model on the table. Whatever the party brings to bear before the Solacre promulgation can tip the final language. If they never engage it, the Commission settles it without them.
- **The Second Seal:** Reached, not opened, end of Session 6. The word FORGIVE. The campaign’s fixed landmark going forward.

# The Undercourt Revelations (DM Only — Sessions 7–8)

- **Un-witnessing:** Oaths bind because they are WITNESSED. The founding assembly turned away in unison — that unbinding is what made the betrayal possible. The shadow feeds on broken oaths AND the silence around them. Every institutional look-away is the same act.
- **The Vigil = the counter-rite:** Witnessing starves it. The Vigil (watched, lit, never alone) is PENANCE, instituted by the witnesses’ descendants — which is why it survives every schism unchanged. The party performed it correctly at Redwatch without being told.
- **The Golden Tablets:** Composed BY the witnesses — the self-exoneration document of the people who looked away. “The Tablets were written over it.” The law was the cover-up, written first.
- **Qilvayas’s Laws = the weapon:** A code making oaths enforceable, witnessed, and recorded is literal starvation for the entity. He built it by instinct, unknowing. The Daily Draw is the Emperor personally witnessing one citizen a day.
- **The Scouring — Emperor Vaskaren the Restorer (~200 yrs ago):** Sought why the empire was failing, found the Hall, erased it. Second crime = same crime (un-witnessing by the founding’s own family). His restoration failed; Qilvayas is the second restorer of that line. His order survives in the dynastic archive — how Nyreeza found the way down, and what waits in her sealed dispatch case.
- **The surviving frieze:** Two spans missed on the eastern gallery’s top tier. Identifiable faces + house-sigils; several of those houses sit at court today. The rubbing is a political bomb — publishing delegitimizes the throne, arms Orlath, vindicates Tarnovar, breaks the Church. Keeping quiet makes the party the newest witnesses to turn away.
- **Threnvos:** Never received a Vigil. Present on the Rite Floor, speaks ONLY his half of the covenant — cannot answer questions, is not exposition. No stat block by design. Laying him to rest SEPARATES grief from hunger: real victory, not the victory.
- **What remains:** The impersonal hunger — doesn’t grieve, doesn’t remember, can’t be reasoned with (that part is now at rest). Fed by every broken word and averted eye. Campaign pivots from dungeon problem to civilization problem.
- **The Matron:** May be down there keeping the vigil nobody else would. Divine magic works; clerics receive. NEVER a form, voice, or confirmation. Ambiguity is permanent and deliberate.

# Branch Ledger — Record the Party’s Divergences

Every session module now carries a Diverging Paths section. Track outcomes here as they resolve; Sessions Seven and beyond are built against this ledger.
...
- Nyreeza’s exact fate — dead, transformed, or trapped: to be discovered through play. (The word FORGIVE at the Second Seal is her last known mark.)
- Countess Ory’s blood-rite mechanism — decide when the Greywell module is built (hag-bargain / fiendish compact / inherited rite).
- The coronation’s metaphysical consequence — a founding covenant sworn while the shadow listens: design when the arc approaches.
- The Piso gun — whether Marshal Dane’s sudden death ever occurs is a standing DM option, never an obligation.
- The throne’s short reigns — the Lupine line cannot hold its throne; mundane on the surface (fever, faction, regency), any deeper cause open by design. Do not resolve at the table.
- What lies past the Second Seal — the next major build (see Roadmap).

~

*Update this guide whenever the sourcebook, session modules, or canon rulings change.*
